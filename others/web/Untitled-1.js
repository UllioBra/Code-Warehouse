...
function(n, t) {
    ...
    e.prototype = {
        init: function() { ! Modernizr.cssfilters && Modernizr.inlinesvg && Modernizr.svgfilters && (element = n(this.element), (this.cssFilterDeprecated(element) || this.settings.fade) && this.switchImage(element))
        },
